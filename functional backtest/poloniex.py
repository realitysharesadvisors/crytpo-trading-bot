...
class poloniex:
    ...
    def api_query(self, command, req={}):
        ...
        if (command == "returnTicker" or command == "return24Volume"):
            ...
            byte_array = ret.read()  # json.loads only accepts a string array, so we must decode first
            str_array = byte_array.decode("utf-8")
            return json.loads(str_array)
